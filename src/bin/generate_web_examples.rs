...
fn main() {
    ...
    let mut out =
        String::from("// Auto-generated by generate-web-examples — do not edit.\n\nexport const EXAMPLES = {\n");

    for web in &manifest.web_example {
        let fixture = fixtures_by_stem
            .get(web.stem.as_str())
            .unwrap_or_else(|| panic!("web_example {:?} references unknown stem {:?}", web.key, web.stem));
